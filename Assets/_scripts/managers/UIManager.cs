...
public class UIManager : MonoBehaviour
{
    ...
    private void InitializeHearts(int maxHealth)
    {
        ...
        healthContainer.GetComponent<RectTransform>()
            .SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, heartSize); // Set heart UI height
        healthContainer.GetComponent<RectTransform>()
            .SetSizeWithCurrentAnchors(RectTransform.Axis.Horizontal,
                heartSize * maxHealth * 1.2f); // Set heart UI Width 
